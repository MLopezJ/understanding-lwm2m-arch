...
CoapNode.prototype._register = function (ip, port, ssid, callback) {
    ...
    //console.log("device", this.so.device)
    this.so.device['0'].manuf = "Nordic"
    this.so.device['0'].model = "model-01"
    this.so.device['0'].serial = "'c-0001"
