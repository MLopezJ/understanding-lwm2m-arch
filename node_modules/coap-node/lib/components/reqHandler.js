        ...
        _.forEach(objList, function (obj) {
            ...
            switch (oid){
                ...
                case 7:
                    ...
                    delete cn.so[cutils.oidKey(oid)];
                    break;
...
function getRspDataAndOption(req, originalData) {
    ...
    /**
     * Uses same content format that the one especified in Register interface
     */
    console.log("generate payload and content format:", originalData)
